...
/**
 * A DTO for the {@link com.risingarjun.arjun.domain.Discounts} entity.
 */
public class DiscountsDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DiscountsDTO discountsDTO = (DiscountsDTO) o;
        if (discountsDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), discountsDTO.getId());
    }
