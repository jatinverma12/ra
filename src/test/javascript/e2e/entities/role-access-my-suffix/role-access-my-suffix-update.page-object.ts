...
export default class RoleAccessUpdatePage {
  ...
  createInput: ElementFinder = element(by.css('input#role-access-my-suffix-create'));
  readInput: ElementFinder = element(by.css('input#role-access-my-suffix-read'));
  updateInput: ElementFinder = element(by.css('input#role-access-my-suffix-update'));
  delInput: ElementFinder = element(by.css('input#role-access-my-suffix-del'));
  roleSelect: ElementFinder = element(by.css('select#role-access-my-suffix-role'));
  featureSelect: ElementFinder = element(by.css('select#role-access-my-suffix-feature'));
