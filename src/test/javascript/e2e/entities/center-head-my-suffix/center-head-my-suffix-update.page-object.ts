...
export default class CenterHeadUpdatePage {
  ...
  centerheadSelect: ElementFinder = element(by.css('select#center-head-my-suffix-centerhead'));
  centerSelect: ElementFinder = element(by.css('select#center-head-my-suffix-center'));
