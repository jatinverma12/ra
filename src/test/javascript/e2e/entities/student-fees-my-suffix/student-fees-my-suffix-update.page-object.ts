...
export default class StudentFeesUpdatePage {
  pageTitle: ElementFinder = element(by.id('risingArjunApp.studentFees.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  feeInput: ElementFinder = element(by.css('input#student-fees-my-suffix-fee'));
  feeCorrectionInput: ElementFinder = element(by.css('input#student-fees-my-suffix-feeCorrection'));
  monthSelect: ElementFinder = element(by.css('select#student-fees-my-suffix-month'));
  feeStatusInput: ElementFinder = element(by.css('input#student-fees-my-suffix-feeStatus'));
  remarksInput: ElementFinder = element(by.css('input#student-fees-my-suffix-remarks'));
  registrationnoSelect: ElementFinder = element(by.css('select#student-fees-my-suffix-registrationno'));
  subjectSelect: ElementFinder = element(by.css('select#student-fees-my-suffix-subject'));
  sessionSelect: ElementFinder = element(by.css('select#student-fees-my-suffix-session'));
  teacherSelect: ElementFinder = element(by.css('select#student-fees-my-suffix-teacher'));
