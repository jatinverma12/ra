...
export default class ChaptersUpdatePage {
  pageTitle: ElementFinder = element(by.id('risingArjunApp.chapters.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  chapterIdInput: ElementFinder = element(by.css('input#chapters-my-suffix-chapterId'));
  chapterTitleInput: ElementFinder = element(by.css('input#chapters-my-suffix-chapterTitle'));
  courseSelect: ElementFinder = element(by.css('select#chapters-my-suffix-course'));
  subjectSelect: ElementFinder = element(by.css('select#chapters-my-suffix-subject'));
