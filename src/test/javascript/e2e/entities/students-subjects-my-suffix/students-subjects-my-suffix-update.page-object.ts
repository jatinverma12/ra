...
export default class StudentsSubjectsUpdatePage {
  pageTitle: ElementFinder = element(by.id('risingArjunApp.studentsSubjects.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  monthSelect: ElementFinder = element(by.css('select#students-subjects-my-suffix-month'));
  registrationnoSelect: ElementFinder = element(by.css('select#students-subjects-my-suffix-registrationno'));
  sessionSelect: ElementFinder = element(by.css('select#students-subjects-my-suffix-session'));
  subjectsSelect: ElementFinder = element(by.css('select#students-subjects-my-suffix-subjects'));
  courseSelect: ElementFinder = element(by.css('select#students-subjects-my-suffix-course'));
