...
export default class ExpensesUpdatePage {
  pageTitle: ElementFinder = element(by.id('risingArjunApp.expenses.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  itemInput: ElementFinder = element(by.css('input#expenses-my-suffix-item'));
  quantityInput: ElementFinder = element(by.css('input#expenses-my-suffix-quantity'));
  rateInput: ElementFinder = element(by.css('input#expenses-my-suffix-rate'));
  laborCostInput: ElementFinder = element(by.css('input#expenses-my-suffix-laborCost'));
  otherExpenseInput: ElementFinder = element(by.css('input#expenses-my-suffix-otherExpense'));
  totalInput: ElementFinder = element(by.css('input#expenses-my-suffix-total'));
  dateInput: ElementFinder = element(by.css('input#expenses-my-suffix-date'));
  transactionIdInput: ElementFinder = element(by.css('input#expenses-my-suffix-transactionId'));
  expenseModeSelect: ElementFinder = element(by.css('select#expenses-my-suffix-expenseMode'));
  typeSelect: ElementFinder = element(by.css('select#expenses-my-suffix-type'));
  billInput: ElementFinder = element(by.css('input#file_bill'));
  remarksInput: ElementFinder = element(by.css('input#expenses-my-suffix-remarks'));
  incurredBySelect: ElementFinder = element(by.css('select#expenses-my-suffix-incurredBy'));
