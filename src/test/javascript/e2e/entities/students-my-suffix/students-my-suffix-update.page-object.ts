...
export default class StudentsUpdatePage {
  pageTitle: ElementFinder = element(by.id('risingArjunApp.students.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  studentRegIdInput: ElementFinder = element(by.css('input#students-my-suffix-studentRegId'));
  registrationFormInput: ElementFinder = element(by.css('input#file_registrationForm'));
  parentMobNo1Input: ElementFinder = element(by.css('input#students-my-suffix-parentMobNo1'));
  parentMobNo2Input: ElementFinder = element(by.css('input#students-my-suffix-parentMobNo2'));
  parentEmailIdInput: ElementFinder = element(by.css('input#students-my-suffix-parentEmailId'));
  studentStatusSelect: ElementFinder = element(by.css('select#students-my-suffix-studentStatus'));
  leavingReasonSelect: ElementFinder = element(by.css('select#students-my-suffix-leavingReason'));
  infoSourceSelect: ElementFinder = element(by.css('select#students-my-suffix-infoSource'));
  userSelect: ElementFinder = element(by.css('select#students-my-suffix-user'));
  courseSelect: ElementFinder = element(by.css('select#students-my-suffix-course'));
