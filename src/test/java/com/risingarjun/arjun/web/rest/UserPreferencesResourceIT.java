...
import com.risingarjun.arjun.repository.UserPreferencesRepository;
import com.risingarjun.arjun.service.UserPreferencesService;
import com.risingarjun.arjun.service.dto.UserPreferencesDTO;
import com.risingarjun.arjun.service.mapper.UserPreferencesMapper;
...
public class UserPreferencesResourceIT {
    ...
    public void createUserPreferences() throws Exception {
        ...
        assertThat(testUserPreferences.getTheme()).isEqualTo(DEFAULT_THEME);
    }
    ...
    public void updateUserPreferences() throws Exception {
        ...
        UserPreferences testUserPreferences = userPreferencesList.get(userPreferencesList.size() - 1);
        assertThat(testUserPreferences.getTheme()).isEqualTo(UPDATED_THEME);
    }
